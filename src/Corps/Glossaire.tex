...
\newacronym[description={\textsl{Adjusted Percentage Reduction in Error}.}]{APRE}{APRE}{\textsl{Adjusted Percentage Reduction in Error}}
...
\newacronym[description={\textsl{Multiple Linear Regression}.}]{MLR}{MLR}{\textsl{Multiple Linear Regression}}

\newacronym[description={\textsl{Mean Squared Error}.}]{MSE}{MSE}{\textsl{Mean Squared Error}}
