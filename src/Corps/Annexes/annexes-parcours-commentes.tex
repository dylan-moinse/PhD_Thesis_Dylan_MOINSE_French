...
\subsubsection{Sélection d'images extraites lors du trajet en métro}
    ...
    % PCTE2 Photo TC 1
    \begin{figure}[h!]\vspace*{4pt}
        \caption*{Extrait n°1 de la vidéo lors du trajet en métro (\(PCTE^{TC}_{2}\))}
    ...
    % PCTE2 Photo TC 2
    \begin{figure}[h!]\vspace*{4pt}
        \caption*{Extrait n°2 de la vidéo lors du trajet en métro (\(PCTE^{TC}_{2}\))}
    ...
    % PCTE2 Photo TC 3
    \begin{figure}[h!]\vspace*{4pt}
        \caption*{Extrait n°3 de la vidéo lors du trajet en métro (\(PCTE^{TC}_{2}\))}
